package com.kevin.common.encryption;

import com.kevin.common.annotation.SecretAnnotationsss;
...
public class DecodeRequestBodyAdvice implements RequestBodyAdvice {
    ...
    public HttpInputMessage beforeBodyRead(HttpInputMessage inputMessage, MethodParameter parameter, Type targetType,
        ...
        boolean annotationPresent = parameter.getMethod().isAnnotationPresent(SecretAnnotationsss.class);

        if (annotationPresent) {
            //获取注解配置的包含和去除字段
            SecretAnnotationsss serializedField = parameter.getMethodAnnotation(SecretAnnotationsss.class);
            //出参是否需要加密
